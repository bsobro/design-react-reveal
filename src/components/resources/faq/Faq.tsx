...
import FaqTabs from "@/components/resources/faq/FaqTabs";
				...
				<div className="max-w-7xl mx-auto py-8 px-4">
                    ...
                    <div className="flex flex-col md:flex-row justify-center items-center mb-4 gap-12">
                        <div className="flex flex-col justify-between md:w-1/2 lg:p-4 gap-4 lg:gap-8">
                            <h3 className="text-4xl font-semibold lg:w-3/4 leading-normal">Frequently Asked Questions</h3>
                            <p className="text-gray-600 text-lg">We’re here to help you make the most of TrackStaff and reach new level of efficiency.</p>
